...
# All Species: Fitting a Snout-vent Length to Weight Model
\begin{equation}
\hat{W}=a(SVL)^b
\end{equation}
...
ggplot(data=whip_lizard_predict)+
  ...
  geom_line(data = lizard_predict, aes(x = SV_length, y = predict,color="all")) +
...
rmselizard <- rmse(lizard_predict$weight, lizard_predict$predict)
